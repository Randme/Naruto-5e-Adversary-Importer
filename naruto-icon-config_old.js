...
const NarutoIconConfig = {
  /**
   * JUTSU/SPELL ICONS
   * Priority: clan > nature > keyword > default
   */
  jutsu: {
    // Clan-specific jutsu (highest priority)
    clan: {
    ...
    // Elemental nature icons (second priority)
    nature: {
